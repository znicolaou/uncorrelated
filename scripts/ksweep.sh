...
./kuramoto -C $ZGN_C -i $ZGN_delta -y 1  -t $ZGN_t1 -a $ZGN_t1 -o $ZGN_t2 -D $ZGN_dt2 -d $ZGN_dt $filebase/uncorrelatedaddconst$ZGN_temp -v &
./kuramoto -C $ZGN_C -i $ZGN_delta -y 1 -c -t $ZGN_t1 -a $ZGN_t1 -o $ZGN_t2 -D $ZGN_dt2 -d $ZGN_dt $filebase/correlatedaddconst$ZGN_temp -v &
wait;
done
